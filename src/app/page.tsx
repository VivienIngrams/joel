...
export default async function HomePage() {
  ...
  return (
    <Link href="/posts" className="block relative h-[100vh] w-full">
      <section className="relative h-full w-full flex flex-col justify-start md:justify-center p-4 md:p-6 items-start pb-[55px] md:pb-[75px] overflow-x-hidden overflow-y-hidden">
        {/* Age Verification Popup */}
        <Verification />

        {/* Content Container */}
        <div className="relative flex-1 w-full border-white border-2 shadow-lg flex overflow-hidden max-w-full h-full">
          {/* Slider */}
        ...
        <div className="absolute bottom-2 inset-x-0 text-center px-4 pointer-events-none">
          <h1 className="uppercase text-white text-5xl md:text-[100px] mb-[-12px] break-words leading-tight">
            Joël Bardeau
          </h1>
