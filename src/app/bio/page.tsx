  ...
  const content = {
    ...
    en: {
      ...
      exhibitions: [
        ...
        'Prix CANSON "Couleur Bleue" for "Anouchka Klein d\'œil"',
        'Arts Vagabonds "Galerie Libre Cours" series "Carrés intimes"',
        'CNIT La Défense Paris, excerpts from " Klein d\'œil"',
        'Article and front page image of "EXCLUSIVE BRAZIL MUNDO"',
        '2 front pages on magazine "EXCLUSIVE BRAZIL MUNDO", series " Klein d\'œil"',
        'Galerie ATYPIC, series Portraits de Femmes',
        'Artistes à suivre, Galerie l’Atelier à Cassaignes, series " Klein d\'œil"',
        'Arts Vagabonds, Le Château St Félix Lauragais, series " Klein d\'œil"',
        'Voyage du Monde Revel, series “Afrique du Sud sauvage”',
        'Artistes à suivre SERRES, series “Bas les Masques”',
        'L’invité d’Arts Vagabonds, Château de Saint-Julia, series « Incertitudes »',
        'Siège social de la Banque Courtois Toulouse : series « Ailes Anciennes »',
        "Salon Créativ'Art Toulouse",
        'Galerie Numeriphot Toulouse "Abemous papam"',
        'Galerie DESVENDA, Porto, Portugal « En Suspension(s) »',
        'Invité d’honneur photographe Festival du film insolite, Renne-le-château « Immortalem »',
        'Salon Européen d’art de Carcassonne "Abemous Papam" Grand Prix',
        'Galerie des Bains Villemur/Tarn, Special guest, series « Abandon(s) »',
        'Vietnam Hôpital de Tan-Hoa, article for “Children Action”',
        'Book published by Mission Than-Hôa documenting from Vietnam, format 25 X 32, 116 pages tirage 1200 ex',
        '44° Salon d’Automne de Colomiers " Abemous Papam" Grand Prix Henri Molina',
        'Les 111 des Arts Hôtel-Dieu Toulouse',
        'Invité d’Honneur du 43° Salon d’Automne de Colomiers, series " Mon corps est ma toile"',
        'NUMERIPHOT Toulouse, Exposition : « New-York-M240 »',
        'Les 111 des Arts Hôtel-Dieu Toulouse',
        '86° Salon des Méridionaux : « Minotaurus »',
        'Galerie ARTIEMPO Toulouse : « Corps et déchirures »',
        "11° FEPN Arles, series 'JE' contre le ‘MOI’",
        'Galerie de l’ECHARPE Toulouse, series " Abemous Papam"',
        "6° Rencontres Focale-nu-art, series 'Le JE' contre le ‘MOI’",
        'Off des 21° Voies Off, Arles, with Collectif APPROCHE-PHOTO, series “Soumissions”',
        'Galerie Dominique.C, Château d’Auriac, series " Mon corps est ma toile"',
        'Château-H St Julia, series " Abemous Papam"',
        'Artists to Follow, « Dante l’Inferno »',
      ],
    },
  }
