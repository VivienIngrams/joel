...
function PostContent({ post }: PostContentProps) {
  return (
    <div className="w-full h-full md:fixed md:max-w-[20vw] md:top-0 md:left-0 md:bg-gradient-to-r from-black to-transparent pt-16 pb-6 md:py-24 px-4 md:px-7  md:text-left z-50">
