...
function PostContent({ post }: PostContentProps) {
  return (
    <div className="w-full h-full md:fixed md:max-w-[22vw] md:top-0 md:left-0 md:bg-gradient-to-r from-[#091129] via-[#091129]/90 to-transparent pt-16 pb-6 md:py-16 px-4 md:px-7 z-40">
